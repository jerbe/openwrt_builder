...
#2. 改默认WIFI SSID名
sed -i 's/ssid=OpenWrt/ssid=D-WiFi/g' openwrt/package/kernel/mac80211/files/lib/wifi
sed -i 's/SSID1=OpenWrt_5G/SSID1=D-WiFi_5G/g' openwrt/package/lean/mt/drivers/mt_wifi/files/mt7612.dat
